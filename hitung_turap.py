def plot_pressure_diagram(self, safety_factor):
    ...
    # Passive Pressure Calculation: Start from the bottom and only go up to the depth of the passive layer
    ...
    # Calculate pressure from the bottom up for the passive layer
