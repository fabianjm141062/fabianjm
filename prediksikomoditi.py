...
# Title of the app
st.title('Commodity & Currency Price AI Deep Learning Prediction with Economic Indicators by Fabian J Manoppo')
...
if data is not None:
    try:
        ...
        if len(data_close) < 60:  # Ensure we have enough data points for the selected time step
            st.error(f"Not enough data available for {commodity_name}. Need at least 60 data points.")
        else:
            ...
            if X_train.shape[0] == 0 or X_test.shape[0] == 0:
                st.error("Not enough data points for training and testing after splitting. Try a smaller time step or provide more data.")
            else:
